...
def imresize(img, scale, antialiasing=True):
    ...
    # process H dimension
    # symmetric copying
    img_aug = torch.empty(in_c, in_h + sym_len_hs + sym_len_he, in_w, dtype=torch.float32)
    ...
    out_1 = torch.empty(in_c, out_h, in_w, dtype=torch.float32)
    ...
    # process W dimension
    # symmetric copying
    out_1_aug = torch.empty(in_c, out_h, in_w + sym_len_ws + sym_len_we, dtype=torch.float32)
    ...
    out_2 = torch.empty(in_c, out_h, out_w, dtype=torch.float32)
